const lines = [
  ...
  "But first, I want to introduce the performers so you can find us all.",
  "[NAMES & INTROS]",
  "If you’re feeling lost, feel free to come ask us to help orient you.",
  ...
  "Pause to reflect.",
  "Physically speaking, a host is an organism that harbors another guest, a parasite,",
  ...
  "How do we spent time together right now? How do we feel welcome?",
  ...
  "And if you don’t get one, there will be one more program after this. And you can share.",
  ...
  "Kamal, Beata, Taylor, Patrick, Music Center team and crew.",
